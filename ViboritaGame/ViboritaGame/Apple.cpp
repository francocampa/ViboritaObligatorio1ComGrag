...
void Apple::draw() {
	glPushMatrix();
	glTranslatef(this->pyramid[0] + GameController::getInstance()->TILE_SIZE / 2.0f, this->pyramid[1], this->pyramid[2] + GameController::getInstance()->TILE_SIZE / 2.0f);
	glScalef(0.2f, 0.2f, 0.2f);
	glColor3f(1, 0.388f, 0.278f);
	drawApple();
	glColor3f(1, 1,1);
	glPopMatrix();
}
