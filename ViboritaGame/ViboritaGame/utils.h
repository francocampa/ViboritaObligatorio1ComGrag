...
enum MODEL_TYPE {APPLE_MODEL, WORM_HEAD_MODEL, WORM_BODY_MODEL, WORM_TAIL_MODEL, GOAL_MODEL, CLOUD1_MODEL, CLOUD2_MODEL, CLOUD3_MODEL, SPIKED_APPLE_MODEL, TITLE_MODEL, ERASOR_MODEL, WORLD_MODEL, WORM_DEAD_HEAD_MODEL};
