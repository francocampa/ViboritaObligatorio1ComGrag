...
enum GAME_ENTITY_TYPE {BLOCK,VIBORITA,APPLE,GOAL,CLOUD};
enum TEX_SETTINGS {FACETADO, INTERPOLADO};
enum MODEL_TYPE {APPLE_MODEL, WORM_HEAD_MODEL, WORM_BODY_MODEL, WORM_TAIL_MODEL, GOAL_MODEL, CLOUD1_MODEL, CLOUD2_MODEL, CLOUD3_MODEL };
